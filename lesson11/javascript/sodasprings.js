 // Weather Summary
 const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&APPID=133721f6e52b26f1b93ecfdf9e059427&units=imperial';
 fetch(apiURL)
 ...
 .then((jsObject) => {
   // console.log(jsObject); // temporary checking for valid response and data parsing
     ...
     // 5 day Forecast
     const apiForecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&APPID=133721f6e52b26f1b93ecfdf9e059427&units=imperial';
